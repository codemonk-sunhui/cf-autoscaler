...
public class ExceptionHandlerAdvice {
	...
	public ResponseEntity<ErrorMessage> entityNotFound(EntityNotFoundException ex){
		ResponseEntity<ErrorMessage> response = new ResponseEntity<ErrorMessage>(new ErrorMessage(ex.getMessage()),HttpStatus.NOT_FOUND);
		return response;
	}
	
	@ExceptionHandler(IllegalArgumentException.class)
	public ResponseEntity<ErrorMessage> illegalArguments(IllegalArgumentException ex){
		ResponseEntity<ErrorMessage> response = new ResponseEntity<ErrorMessage>(new ErrorMessage(ex.getMessage()),HttpStatus.BAD_REQUEST);
		return response;
	}
	
	@ExceptionHandler(IllegalStateException.class)
	public ResponseEntity<ErrorMessage> illegalState(IllegalStateException ex){
		ResponseEntity<ErrorMessage> response = new ResponseEntity<ErrorMessage>(new ErrorMessage(ex.getMessage()),HttpStatus.CONFLICT);
		return response;
	}

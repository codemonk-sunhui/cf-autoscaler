...
public class CatalogController {
	...
	public Catalog list() {
		List<ServiceDefinition> services = service.listServiceDefinition();
	...
	public ResponseEntity<String> deleteServiceDefinition(
			@PathVariable("sid") String serviceInstanceId) {
